/**
 * Pure hub highlight and signal builders.
 *
 * This module derives factual highlight picks, stat breakdowns, and trust posture
 * summaries from registry entry metadata. Nothing here touches the network — given
 * the same entries the output is deterministic.
 *
 * The public surface (`hub-highlights.ts` / `@/lib/hub-highlights`) re-exports
